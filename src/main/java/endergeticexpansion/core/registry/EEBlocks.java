...
public class EEBlocks {
	...
	public static final RegistryObject<Block> CORROCK_OVERWORLD_BLOCK           = HELPER.createBlock("corrock_overworld_block", () -> new CorrockBlock(EEProperties.CORROCK_BASE(MaterialColor.BROWN_TERRACOTTA, true), false), ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> PETRIFIED_CORROCK_OVERWORLD_BLOCK = HELPER.createBlock("petrified_corrock_overworld_block", () -> new CorrockBlock(EEProperties.CORROCK_BASE(MaterialColor.BROWN_TERRACOTTA, true), true), null);
	public static final RegistryObject<Block> CORROCK_NETHER_BLOCK              = HELPER.createBlock("corrock_nether_block", () -> new CorrockBlock(EEProperties.CORROCK_BASE(MaterialColor.RED_TERRACOTTA, true), false), ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> PETRIFIED_CORROCK_NETHER_BLOCK    = HELPER.createBlock("petrified_corrock_nether_block", () -> new CorrockBlock(EEProperties.CORROCK_BASE(MaterialColor.RED_TERRACOTTA, true), true), null);
	public static final RegistryObject<Block> CORROCK_END_BLOCK                 = HELPER.createBlock("corrock_end_block", () -> new CorrockBlock(EEProperties.CORROCK_BASE(MaterialColor.PURPLE_TERRACOTTA, true), false), ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> PETRIFIED_CORROCK_END_BLOCK       = HELPER.createBlock("petrified_corrock_end_block", () -> new CorrockBlock(EEProperties.CORROCK_BASE(MaterialColor.PURPLE_TERRACOTTA, true), true), null);
	public static final RegistryObject<Block> CORROCK_OVERWORLD                 = HELPER.createBlock("corrock_overworld", () -> new CorrockPlantBlock(EEProperties.CORROCK_BASE(MaterialColor.BROWN_TERRACOTTA, false), false), ItemGroup.DECORATIONS);
	public static final RegistryObject<Block> PETRIFIED_CORROCK_OVERWORLD       = HELPER.createBlock("petrified_corrock_overworld", () -> new CorrockPlantBlock(EEProperties.CORROCK_BASE(MaterialColor.BROWN_TERRACOTTA, false), true), null);
	public static final RegistryObject<Block> CORROCK_NETHER                    = HELPER.createBlock("corrock_nether", () -> new CorrockPlantBlock(EEProperties.CORROCK_BASE(MaterialColor.RED_TERRACOTTA, false), false), ItemGroup.DECORATIONS);
	public static final RegistryObject<Block> PETRIFIED_CORROCK_NETHER          = HELPER.createBlock("petrified_corrock_nether", () -> new CorrockPlantBlock(EEProperties.CORROCK_BASE(MaterialColor.RED_TERRACOTTA, false), true), null);
	public static final RegistryObject<Block> CORROCK_END                       = HELPER.createBlock("corrock_end", () -> new CorrockPlantBlock(EEProperties.CORROCK_BASE(MaterialColor.PURPLE_TERRACOTTA, false), false), ItemGroup.DECORATIONS);
	public static final RegistryObject<Block> PETRIFIED_CORROCK_END             = HELPER.createBlock("petrified_corrock_end", () -> new CorrockPlantBlock(EEProperties.CORROCK_BASE(MaterialColor.PURPLE_TERRACOTTA, false), true), null);
	public static final RegistryObject<CorrockCrownWallBlock> CORROCK_CROWN_OVERWORLD_WALL           = HELPER.createBlockNoItem("corrock_crown_wall_overworld", () -> new CorrockCrownWallBlock(EEProperties.CORROCK_BASE_GLOWING(MaterialColor.BROWN), false));
	public static final RegistryObject<CorrockCrownWallBlock> PETRIFIED_CORROCK_CROWN_OVERWORLD_WALL = HELPER.createBlockNoItem("petrified_corrock_crown_wall_overworld", () -> new CorrockCrownWallBlock(EEProperties.CORROCK_BASE_GLOWING(MaterialColor.BROWN), true));
	public static final RegistryObject<CorrockCrownBlock> CORROCK_CROWN_OVERWORLD_STANDING           = HELPER.createCorrockStandingBlock("corrock_crown_standing_overworld", () -> new CorrockCrownStandingBlock(EEProperties.CORROCK_BASE_GLOWING(MaterialColor.BROWN), false), () -> CORROCK_CROWN_OVERWORLD_WALL.get(), ItemGroup.DECORATIONS);
	public static final RegistryObject<CorrockCrownBlock> PETRIFIED_CORROCK_CROWN_OVERWORLD_STANDING = HELPER.createCorrockStandingBlock("petrified_corrock_crown_standing_overworld", () -> new CorrockCrownStandingBlock(EEProperties.CORROCK_BASE_GLOWING(MaterialColor.BROWN), true), () -> PETRIFIED_CORROCK_CROWN_OVERWORLD_WALL.get(), null);
	public static final RegistryObject<CorrockCrownWallBlock> CORROCK_CROWN_NETHER_WALL              = HELPER.createBlockNoItem("corrock_crown_wall_nether", () -> new CorrockCrownWallBlock(EEProperties.CORROCK_BASE_GLOWING(MaterialColor.RED), false));
	public static final RegistryObject<CorrockCrownWallBlock> PETRIFIED_CORROCK_CROWN_NETHER_WALL    = HELPER.createBlockNoItem("petrified_corrock_crown_wall_nether", () -> new CorrockCrownWallBlock(EEProperties.CORROCK_BASE_GLOWING(MaterialColor.RED), true));
	public static final RegistryObject<CorrockCrownBlock> CORROCK_CROWN_NETHER_STANDING              = HELPER.createCorrockStandingBlock("corrock_crown_standing_nether", () -> new CorrockCrownStandingBlock(EEProperties.CORROCK_BASE_GLOWING(MaterialColor.RED), false), () -> CORROCK_CROWN_NETHER_WALL.get(), ItemGroup.DECORATIONS);
	public static final RegistryObject<CorrockCrownBlock> PETRIFIED_CORROCK_CROWN_NETHER_STANDING    = HELPER.createCorrockStandingBlock("petrified_corrock_crown_standing_nether", () -> new CorrockCrownStandingBlock(EEProperties.CORROCK_BASE_GLOWING(MaterialColor.RED), true), () -> PETRIFIED_CORROCK_CROWN_NETHER_WALL.get(), null);
	public static final RegistryObject<CorrockCrownWallBlock> CORROCK_CROWN_END_WALL                 = HELPER.createBlockNoItem("corrock_crown_wall_end", () -> new CorrockCrownWallBlock(EEProperties.CORROCK_BASE_GLOWING(MaterialColor.PURPLE), false));
	public static final RegistryObject<CorrockCrownWallBlock> PETRIFIED_CORROCK_CROWN_END_WALL       = HELPER.createBlockNoItem("petrified_corrock_crown_wall_end", () -> new CorrockCrownWallBlock(EEProperties.CORROCK_BASE_GLOWING(MaterialColor.PURPLE), true));
	public static final RegistryObject<CorrockCrownBlock> CORROCK_CROWN_END_STANDING                 = HELPER.createCorrockStandingBlock("corrock_crown_standing_end", () -> new CorrockCrownStandingBlock(EEProperties.CORROCK_BASE_GLOWING(MaterialColor.PURPLE), false), () -> CORROCK_CROWN_END_WALL.get(), ItemGroup.DECORATIONS);
	public static final RegistryObject<CorrockCrownBlock> PETRIFIED_CORROCK_CROWN_END_STANDING       = HELPER.createCorrockStandingBlock("petrified_corrock_crown_standing_end", () -> new CorrockCrownStandingBlock(EEProperties.CORROCK_BASE_GLOWING(MaterialColor.PURPLE), true), () -> PETRIFIED_CORROCK_CROWN_END_WALL.get(), null);
	 ...
	 * Poise Forest
	 */
	public static final RegistryObject<PoismossEumusBlock> POISMOSS_EUMUS         = HELPER.createBlock("poismoss_eumus", () -> new PoismossEumusBlock(EEProperties.POISMOSS_EUMUS), ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<PoismossBlock> POISMOSS                    = HELPER.createBlock("poise_grass_block", () -> new PoismossBlock(EEProperties.POISE_GRASS(false)), ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<PoiseBushBlock> POISE_BUSH                 = HELPER.createBlock("poise_grass", () -> new PoiseBushBlock(EEProperties.POISE_GRASS(true)), ItemGroup.DECORATIONS);
	public static final RegistryObject<PoiseTallBushBlock> POISE_BUSH_TALL        = HELPER.createBlock("poise_grass_tall", () -> new PoiseTallBushBlock(EEProperties.POISE_GRASS(true)), ItemGroup.DECORATIONS);
	...
	public static final RegistryObject<DispensedBoofBlock> BOOF_BLOCK_DISPENSED   = HELPER.createBlockNoItem("boof_dispensed_block", () -> new DispensedBoofBlock(EEProperties.BOOF_BLOCK.doesNotBlockMovement().notSolid().hardnessAndResistance(-1, 3600000.0F)));
